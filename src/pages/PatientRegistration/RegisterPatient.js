...
function RegisterPatient() {
    ...
    const filterMedicalConditions = (event) => {
        ...
        axios.get(`https://ec2-13-232-74-29.ap-south-1.compute.amazonaws.com:443/ws/rest/IntegrationAPI/conditions/search/${event.target.value}`)
        .then(response => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const respGlobal = await axios(`https://ec2-13-232-74-29.ap-south-1.compute.amazonaws.com:443/ws/rest/IntegrationAPI/conditions/all`);
    ...
    const rowClicked = () => {
        ...
        axios.post('https://ec2-13-232-74-29.ap-south-1.compute.amazonaws.com:443/ws/rest/IntegrationAPI/conditions/create',reqJson)
        .then (response => {
            console.log(response);
            setMedicalConditions(response.data.MedicalConditions);
